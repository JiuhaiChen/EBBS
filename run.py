...
class RunModel:
    ...
    def load_academic(self, data_name):
        ...
        return (
            ...
            labels.reshape(-1).to(self.device),
            train_mask,
            test_mask,
            val_mask,
        )
    ...
    def run_one_model(self, data_name, task, seed, X_lam, X_step, y_lam, y_step, lr, momentum, error_smooth, label_smooth):
        ...
        elif data_name in ["house", "county", "vk", "avazu", "wiki", "house_class", "vk_class", "dblp", "slap"]:
        ...
        metrics = model.train(
            encoded_X, target, cat_features=None, num_boost_round=1000, early_stopping_rounds=20
        )
